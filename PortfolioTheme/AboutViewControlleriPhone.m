...
- (void) playMovie {
    ...
    controller.view.frame =  CGRectMake(0, 50, 320, 205);//Set the size
    
    
    [self.Content addSubview:controller.view]; //Show the view
...
{
    BKTPopin2ControllerViewController_about2i *popin = [[BKTPopin2ControllerViewController_about2i alloc] init];
    //Disable auto dismiss and removed semi-transparent background
    [popin setPopinOptions:BKTPopinDisableAutoDismiss|BKTPopinDimmingViewStyleNone];
